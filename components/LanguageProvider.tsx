...
export const translations: Translations = {
  ...
  "settings.theme_style": { en: "Theme Style", id: "Gaya Tema" },
  "settings.style_md3": { en: "MD3 Expressive", id: "MD3 Ekspresif" },
  ...
  "session.copy_from_previous": { en: "Copy from Previous", id: "Salin dari Sebelumnya" },
  "session.copy_modal_title": { en: "Recent Sessions", id: "Sesi Terbaru" },
  "session.copy_use": { en: "Use This Session", id: "Gunakan Sesi Ini" },
  "session.copy_no_sessions": { en: "No previous sessions yet", id: "Belum ada sesi sebelumnya" },
  "session.copy_loaded": { en: "Loaded [N] customers from previous session", id: "[N] pelanggan dimuat dari sesi sebelumnya" },
  "session.scan_manifest": { en: "Scan Manifest", id: "Pindai Manifest" },
  "session.scan_title": { en: "Scan Delivery Manifest", id: "Pindai Manifest Pengiriman" },
  "session.scan_desc": { en: "Take a photo of the delivery manifest or screenshot from the company app", id: "Ambil foto manifest pengiriman atau screenshot dari aplikasi perusahaan" },
  "session.scan_take": { en: "Take Photo", id: "Ambil Foto" },
  "session.scan_gallery": { en: "From Gallery", id: "Dari Galeri" },
  "session.scan_processing": { en: "Processing image...", id: "Memproses gambar..." },
  "session.scan_result": { en: "Extracted Text", id: "Teks yang Diekstrak" },
  "session.scan_parse": { en: "Parse", id: "Parse" },
  "session.scan_parsing": { en: "Parsing...", id: "Memparse..." },
  "session.scan_no_text": { en: "No text found in image", id: "Tidak ada teks ditemukan di gambar" },
  "session.scan_parsed": { en: "Found [N] customers from scan", id: "Ditemukan [N] pelanggan dari scan" },
  "session.scan_error": { en: "Failed to scan image", id: "Gagal memindai gambar" },
  "session.scan_matched": { en: "matched", id: "cocok" },
  "session.scan_unmatched": { en: "new", id: "baru" },
