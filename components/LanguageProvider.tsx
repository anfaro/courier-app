...
export const translations: Translations = {
  ...
  "gallery.delete_image": { en: "Delete Image", id: "Hapus Gambar" },
  "gallery.delete_confirm_title": { en: "Delete Image?", id: "Hapus Gambar?" },
  "gallery.delete_confirm_msg": { en: "This will remove the image from this customer.", id: "Ini akan menghapus gambar dari pelanggan ini." },
  "gallery.image_deleted": { en: "Image deleted", id: "Gambar dihapus" },
  "gallery.analytics_title": { en: "Photo Coverage", id: "Cakupan Foto" },
  "gallery.with_photos": { en: "With Photos", id: "Ada Foto" },
  "gallery.broken_urls": { en: "Broken URLs", id: "URL Rusak" },
  "gallery.no_photos": { en: "No Photos", id: "Tidak Ada Foto" },
  "gallery.analytics_loading": { en: "Checking coverage...", id: "Memeriksa cakupan..." },
  "gallery.editor": { en: "Gallery Editor", id: "Editor Galeri" },
  "gallery.editor_subtitle": { en: "Add, update, or remove customer house photos", id: "Tambah, perbarui, atau hapus foto rumah pelanggan" },
  "gallery.editor_title": { en: "Gallery Editor", id: "Editor Galeri" },
  "gallery.editor_page_subtitle": { en: "Manage house photos for your customers", id: "Kelola foto rumah pelanggan Anda" },
  "gallery.save": { en: "Save", id: "Simpan" },
  "gallery.saved": { en: "Changes saved", id: "Perubahan disimpan" },
  "gallery.no_customers": { en: "No customers found", id: "Tidak ada pelanggan ditemukan" },
