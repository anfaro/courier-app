    ...
    <div className="flex flex-col h-[100dvh] bg-background overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto custom-scrollbar pb-32">
        ...
        <div className="px-4 sm:px-6 mb-8">
          <h2 className="text-[14px] font-bold tracking-tight text-primary mb-3 uppercase tracking-widest">Management</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/admin/users" className="flex items-center justify-between rounded-[24px] bg-card p-5 shadow-sm border border-card-border active:scale-[0.98] transition-all hover:border-purple-200 dark:hover:border-purple-900/50">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] font-medium text-secondary mt-0.5">Promote, demote, or offboard couriers</span>
                </div>
              </div>
            ...
            <Link href="/admin/customers" className="flex items-center justify-between rounded-[24px] bg-card p-5 shadow-sm border border-card-border active:scale-[0.98] transition-all hover:border-blue-200 dark:hover:border-blue-900/50">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] font-medium text-secondary mt-0.5">Bulk manage and cleanup records</span>
                </div>
              </div>
              <span className="text-secondary opacity-30">→</span>
            </Link>
            ...
            <Link href="/admin/deliveries" className="flex items-center justify-between rounded-[24px] bg-card p-5 shadow-sm border border-card-border active:scale-[0.98] transition-all hover:border-emerald-200 dark:hover:border-emerald-900/50">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="font-black text-primary leading-tight">Waybill Management</span>
                  <span className="text-[11px] font-medium text-secondary mt-0.5">Track and audit all deliveries</span>
                </div>
              </div>
              <span className="text-secondary opacity-30">→</span>
            </Link>

            <Link href="/admin/clusters" className="flex items-center justify-between rounded-[24px] bg-card p-5 shadow-sm border border-card-border active:scale-[0.98] transition-all hover:border-orange-200 dark:hover:border-orange-900/50">
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 bg-orange-50 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center text-2xl">📍</div>
                <div className="flex flex-col">
                  <span className="font-black text-primary leading-tight">Cluster Management</span>
                  <span className="text-[11px] font-medium text-secondary mt-0.5">Zone and region administration</span>
                </div>
              </div>
              <span className="text-secondary opacity-30">→</span>
            </Link>
